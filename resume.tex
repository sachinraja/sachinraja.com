...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      {Vercel}
      \resumeItemListStart
        \resumeItem{Implemented request collapsing and origin shielding for Vercel's global Content Delivery Network impacting 25 requests/second, serving them from Vercel's distributed cache instead of the origin server}
